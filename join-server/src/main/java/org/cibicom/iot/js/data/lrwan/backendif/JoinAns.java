...
public class JoinAns {
    ...
    public JoinAns(String protocolVersion, String senderID, String receiverID, Long transactionID, String PHYPayload, Result result, Integer lifeTime, String sessionKeyID) {
    ...
    public JoinAns(String protocolVersion, String senderID, String receiverID, Long transactionID, String messageType) {
        this.protocolVersion = protocolVersion;
        this.senderID = senderID;
        this.receiverID = receiverID;
        this.transactionID = transactionID;
